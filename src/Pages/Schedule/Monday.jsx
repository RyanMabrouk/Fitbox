      ...
      <div className="mt-[5rem]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex w-full justify-between min800:flex-col min800:text-center">
            ...
            <li className="flex w-full items-center justify-end bg-[#f2f2f2] px-[55px] py-[25px] min800:justify-center">
              <Link
                onClick={() => window.top(0, 0)}
                to="/contact"
                className="rounded-[30px] bg-[#555] px-[20px] py-[10px] text-[15px] font-medium text-white duration-200 ease-in hover:bg-[#eab308]"
              >
                Join Now
              </Link>
            </li>
          ...
          <ul className="flex w-full justify-between min800:flex-col min800:text-center">
            ...
            <li className="flex w-full items-center justify-end bg-[#f2f2f2] px-[55px] py-[25px] min800:justify-center">
              <Link
                onClick={() => window.top(0, 0)}
                to="/contact"
                className="mt-3 rounded-[30px] bg-[#555] px-[20px] py-[10px] text-[15px] font-medium text-white duration-200 ease-in hover:bg-[#eab308]"
              >
                Join Now
              </Link>
            </li>
